...
import indoor1 from "../assets/indoor1.avif";
import indoor2 from "../assets/indoor2.avif";
import indoor3 from "../assets/indoor3.avif";
import indoor4 from "../assets/indoor4.avif";
import indoor5 from "../assets/indoor5.avif";
import indoor6 from "../assets/indoor6.avif";
import indoor7 from "../assets/indoor7.avif";
  ...
  return (
    <div className="min-h-screen bg-[#172218]">
      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        <h2 className="text-3xl font-bold text-white mb-2">Indoor Plants Collection</h2>
        <p className="text-white/50 mb-8">Bring nature inside your home</p>
